...
# Simulate unbiased death dates based on age-specific unconditional death rates

# === File paths ===
INPUT_CSV = r"C:\github\CzechFOI-DRATE\TERRA\Vesely_106_202403141131.csv"
OUTPUT_CSV = r"C:\github\CzechFOI-DRATE\TERRA\sim_SELCTION_BIAS_Vesely_106_202403141131.csv"
...
DOSE_DATE_COLS = [f'Datum_{i}' for i in range(1, 8)]  # Adjusted to match actual column names
...
def main():
    ...
    print("🗓️  Parsing dates and calculating ages...")
    df = parse_dates(df)
    df = calculate_age(df)
    ...
    print(f"📅 End measure = {end_measure} days since {START_DATE.date()}")
